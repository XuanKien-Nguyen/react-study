    ...
    render() {
        return (
            <header>
                ...
                <nav className="navbar fixed-top navbar-toggleable-md navbar-expand-lg navbar-dark bg-dark scrolling-navbar double-nav">
                    ...
                    <ul className="nav navbar-nav nav-flex-icons ml-auto">
                        <li className="nav-item dropdown">
                            <a className="nav-link dropdown-toggle waves-effect waves-light" id="dropdownMenu1" data-toggle="dropdown" aria-haspopup="true"
                                aria-expanded="false">
                                <i className="fa fa-user mr-sm-2"></i>ACCOUNT</a>
                            <div className="dropdown-menu dropdown-menu-right" aria-labelledby="dropdownMenu1">
                                <a className="dropdown-item waves-effect waves-light">SIGN UP</a>
                                <a className="dropdown-item waves-effect waves-light">LOG IN</a>
                                <a className="dropdown-item waves-effect waves-light">LOG OUT</a>
                            </div>
                        </li>
                    </ul>
